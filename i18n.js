const translations = {
  en: {
    ...
    aboutIntro2: 'Previously, I was at <a href="https://promptfoo.dev" target="_blank" rel="noopener">Promptfoo</a>, where I helped scale an open-source community of over 300k.',
    aboutIntro3: "In my free time, I like to learn languages, spend time outside and build AI projects.",
    aboutBtn: "About Me",
  ...
  ka: {
    ...
    aboutIntro3: "თავისუფალ დროს მიყვარს ენების სწავლა, ბუნებაში დროის გატარება და AI პროექტების შექმნა.",
